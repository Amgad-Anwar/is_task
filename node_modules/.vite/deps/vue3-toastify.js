...
function Me(e) {
  var E;
  const { position: t, containerClassName: n, rtl: a = false, style: o = {} } = e, s = r.CSS_NAMESPACE, d = qe(t), v = document.querySelector(`.${s}`), u = document.querySelector(`.${d}`), p = !!u && !((E = u.className) != null && E.includes(K)), m = v || document.createElement("div"), S = document.createElement("div");
  S.className = Be(
    t,
    n,
    a
...
var We = defineComponent({
  ...
  setup(e, {
    ...
    }, p = computed(() => e.controlledProgress ? null : u), m = computed(() => e.controlledProgress ? u : null);
    return watchEffect(() => {
...
function st(e) {
  ...
  }), d = s.done || at, v = computed(() => s.appendPosition ? `${s.enter}--${s.position}` : s.enter), u = computed(() => s.appendPosition ? `${s.exit}--${s.position}` : s.exit), p = computed(() => e.pauseOnHover ? {
    onMouseenter: h2,
    onMouseleave: I
  } : {});
  function m() {
